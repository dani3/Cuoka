...
public class DotsLargeView extends View
{
    private static final int DOTS_COUNT = 7;
    private static final int OUTER_DOTS_POSITION_ANGLE = 360 / DOTS_COUNT;

    private static final int COLOR_1 = 0xFF83374D;
    private static final int COLOR_2 = 0xFF4C0A1D;
    private static final int COLOR_3 = 0xFFA95970;
    private static final int COLOR_4 = 0xFF6C1E34;
    ...
    public DotsLargeView(Context context) {
        super(context);
        init();
    }

    public DotsLargeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DotsLargeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static final Property<DotsLargeView, Float> DOTS_PROGRESS = new Property<DotsLargeView, Float>(Float.class, "dotsProgress") {
        @Override
        public Float get(DotsLargeView object) {
            return object.getCurrentProgress();
        }

        @Override
        public void set(DotsLargeView object, Float value) {
