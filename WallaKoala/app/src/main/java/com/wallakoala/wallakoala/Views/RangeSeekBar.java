...
import com.wallakoala.wallakoala.Utils.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    /**
     * Default color of a {@link RangeSeekBar}, #ColorAccent
     */
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.colorMediumText));
        ...
        int colorToUseForButtonsAndHighlightedLine = selectedValuesAreDefault ?
                getResources().getColor(R.color.colorLightText):    // default values
