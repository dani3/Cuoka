...
{
    public static final String IMAGE_PATH = System.getProperty( "user.dir" ) + "/resources/images/";
    public static final String RESIZED_IMAGE_PATH = "/var/www/html/images/";
    public static final String DEFAULT_IMAGE = System.getProperty( "user.dir" ) + "/resources/images/default.jpg";
