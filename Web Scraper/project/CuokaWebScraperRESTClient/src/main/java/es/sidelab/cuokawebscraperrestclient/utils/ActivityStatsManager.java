...
public class ActivityStatsManager {
   ...
   private static CopyOnWriteArrayList<ShopActivityStats> shopActivityList = new CopyOnWriteArrayList<ShopActivityStats>();
   ...
   public static void writeOnFile(){
       ...
       try{
           ...
           for( ShopActivityStats shopActivity : shopActivityList ){
            ...
            LOG.error("Fallo en fichero Activity");
       }
       finally{
           try {
              if (null != file)
   ...
   /*Ponemos el numero de productos que han ido bien y mal por seccion*/
